    ...
    return (
        <DrawerPortal>
            ...
            <DrawerPrimitives.Content
                ref={ref}
                className={clx(
                    "bg-ui-bg-base shadow-elevation-modal border-ui-border-base fixed inset-y-0 right-0 flex w-full max-w-[560px] flex-1 flex-col border focus:outline-none",
...
>(({children, className, ...props}, ref) => {
    return (
        <div ref={ref} {...props}
             className="border-ui-border-base flex items-start justify-between gap-x-4 border-b p-5">
