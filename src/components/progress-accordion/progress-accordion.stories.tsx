      ...
      <Container className="p-0">
        ...
        >
          ...
          <ProgressAccordion.Item value="1">
            <ProgressAccordion.Header status="in-progress">Trigger 1</ProgressAccordion.Header>
            <ProgressAccordion.Content>
              <div className="pb-6">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. A
                recusandae officiis aliquam quia, natus saepe obcaecati eligendi
          ...
          <ProgressAccordion.Item value="3">
            <ProgressAccordion.Header status="completed">Trigger 1</ProgressAccordion.Header>
            <ProgressAccordion.Content>
              <div className="pb-6">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. A
                recusandae officiis aliquam quia, natus saepe obcaecati eligendi
