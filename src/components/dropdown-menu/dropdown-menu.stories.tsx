import { DotsHorizontal, Pencil02, Plus, Trash03 } from "@netist/icons";
      ...
      <DropdownMenu>
        ...
        <DropdownMenu.Content>
          <DropdownMenu.Item className="gap-x-2">
            <Pencil02 className="text-ui-fg-subtle" width={16} height={16}/>
            Edit
          </DropdownMenu.Item>
          <DropdownMenu.Item className="gap-x-2">
            <Plus className="text-ui-fg-subtle" width={16} height={16}/>
            Add
          </DropdownMenu.Item>
          <DropdownMenu.Separator />
          <DropdownMenu.Item className="gap-x-2">
            <Trash03 className="text-ui-fg-subtle" width={16} height={16}/>
            Delete
          </DropdownMenu.Item>
        </DropdownMenu.Content>
      </DropdownMenu>
